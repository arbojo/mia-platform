    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-brand-50 to-white">
      <header className="border-b bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <h1 className="text-xl font-bold text-brand-900">MIA Demo</h1>
          <div className="flex gap-4">
            {user ? (
              ...
              <>
                ...
                <Link href="/signup">
                  <Button className="bg-brand-600 hover:bg-brand-700">Crear cuenta</Button>
                </Link>
              </>
            )}
          </div>
        ...
        <div className="flex-1 flex flex-col border rounded-xl overflow-hidden bg-white shadow-sm min-h-0">
          <div className="p-4 border-b bg-brand-50">
            <div className="flex items-center gap-3">
              <Avatar>
                <AvatarFallback className="bg-brand-200 text-brand-700">L</AvatarFallback>
              </Avatar>
              <div>
