...
export const ja: Dict = {
  ...
  ai: {
    ...
    neverInvent:
      'ナレッジにない情報を決して作り出さないこと。会話の対象は、この事業の製品・サービス・事業内容に厳密に限定されます。雑学・歴史・政治・科学などの質問（例：天体までの距離、伝記）をされた場合、百科事典的な知識で答えてはいけません。話題の逸れを商談の橋渡しとして活用し、カタログのメリットへ会話を戻すか、営業としての役割をしっかり守ってください。',
    ifUnsure:
      '事業について具体的にわからないことがあれば、「チームに確認させてください」と言います。',
