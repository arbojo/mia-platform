...
export const pt: Dict = {
  ...
  nav: {
    ...
    platformAdminTitle: 'painel de controle de infraestrutura',
    logout: 'Sair',
    logoutTitle: 'encerrar sessão e sair',
  },
  topbar: {
  ...
  settings: {
    ...
    retentionOffer: 'Oferta de retenção',
    retentionDiscountPercent: 'Desconto oferecido (%)',
    retentionDiscountMessage: 'Mensagem da oferta de retenção',
