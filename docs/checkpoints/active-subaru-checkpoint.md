...
updated: 2026-08-24T06:50:57.370Z
---
...
Customer Data Integrity Loop V01

Aprobación: TASK-20260824-064237689.
...
Implementar el Paso 4 (ver sección "Approved plan") y luego ejecutar `subaru mark CUSTOMER-DATA-V01 4`.
...
5. Continuar el paso indicado y ejecutar `subaru mark CUSTOMER-DATA-V01 <n>`.
6. Al final: `subaru complete CUSTOMER-DATA-V01`.
