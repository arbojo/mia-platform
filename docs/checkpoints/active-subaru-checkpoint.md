...
- [x] **Paso 6 (D):** `mark` secuencial: solo permite marcar `currentStep + 1`;
...
- [x] **Paso 8 (F+K):** `revive` completo: (a) validar legibilidad del checkpoint
...
- [x] **Paso 10 (gates):** `npm run lint`, `npm run build`, security_review
